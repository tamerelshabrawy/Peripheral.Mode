 ...
 * The walk is an irregular loop (~1.2 km total) in Alexandria, Egypt.
 *
...
const ZONE_FAMILIES = [
    ...
    6, 6, 6, 6,          // zones 28–31 → family 6 (Track 3)
    7, 7, 7, 7           // zones 32–35 → family 7 (Track 4 / Street Aura)
];
